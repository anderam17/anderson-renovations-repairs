...
function ContactContainer() {
  return (
    ...
    <div className="row">
        ...
        <ContactCard subtitle="Facebook" description="Search on facebook, look for our purple logo:" contactInfo="anderson renovations and repairs" faIcon={faFacebookSquare}/>
        </div>
    </div>
    </>
  );
